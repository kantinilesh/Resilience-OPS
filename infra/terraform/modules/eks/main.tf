# Reusable EKS Cluster Module with Autoscaling & IRSA
terraform {
...
# ============================================================
# 1. Cluster Security Group & Node Security Group
# ============================================================
...
# ============================================================
# 3. EKS Managed Node Group (Autoscaling 2–6 nodes)
# ============================================================
...
# ============================================================
# 4. OpenID Connect (OIDC) Identity Provider for IRSA
# ============================================================
...
# ============================================================
# 5. IRSA Role for Prometheus & CloudWatch Access
# ============================================================
locals {
        ...
        Condition = {
          StringEquals = {
            "${local.oidc_issuer}:sub" = [
              ...
              "system:serviceaccount:monitoring:amazon-cloudwatch"
            ],
...
resource "aws_iam_policy" "cloudwatch_metrics_policy" {
  name        = "${var.cluster_name}-cloudwatch-access-policy"
  description = "Allows Prometheus and CloudWatch agent to query and export CloudWatch metrics"
