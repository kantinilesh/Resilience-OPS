...
public class InventoryChaosController {

    private static final Logger log = LoggerFactory.getLogger(InventoryChaosController.class);
    ...
    public InventoryChaosController(ChaosHealthIndicator healthIndicator) {
    ...
    public ResponseEntity<Map<String, Object>> simulateFailure(@RequestBody Map<String, Object> request) {
        ...
        log.warn("INVENTORY CHAOS HOOK INVOKED: action={}, durationSeconds={}", action, durationSeconds);
        ...
        switch (action.toLowerCase()) {
            case "cpu-spike":
                ...
                return ResponseEntity.ok(Map.of(
                        ...
                        "message", "CPU stress workers spawned on inventory-service"
                ));
            ...
            case "liveness-fail":
                healthIndicator.tripLiveness("Simulated database connection lockup via /admin/chaos");
                return ResponseEntity.ok(Map.of(
            ...
            case "crash":
                CompletableFuture.runAsync(() -> {
                    ...
                    log.error("CRITICAL CHAOS: System.exit(1) invoked deliberately on inventory-service.");
                    System.exit(1);
                });
                return ResponseEntity.ok(Map.of(
                        "action", "crash",
            ...
            case "reset":
                ...
                return ResponseEntity.ok(Map.of(
                        "action", "reset",
                        "status", "RESTORED",
                        "message", "Chaos states cleared on inventory-service"
                ));
